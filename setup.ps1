New-Item -ItemType Directory -Force -Path 'srcpp\login' | Out-Null
...
'@ | Set-Content -Path 'srcpp\page.tsx' -Encoding UTF8
...
'@ | Set-Content -Path 'srcpp\login\page.tsx' -Encoding UTF8
